...
Remember AGENTS.md's dashboard rules apply here too: a `DATA: YYYY-MM-DD` chip if the page
...
## Color & Text Rules (inherited from AGENTS.md — repeated here because it's easy to violate in chart code)
