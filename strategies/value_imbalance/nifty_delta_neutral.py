    ...
    def run(self):
        ...
        while True:
            ...
            while cycle_active:
                ...
                # flattened a leg we still think is open. (Not the inversion guard —
                # this strategy deliberately allows CE strike < PE strike; this check
                # only cares whether the broker still shows the leg open at all.)
