...
export async function POST(req: NextRequest) {
  ...
  const args = [
    ...
    '--overall-sl-val',      String(body.overall_sl_val      ?? body.overall_sl_pct ?? 0),
    '--overall-sl-type',     String(body.overall_sl_type     ?? 'pct'),
    '--protect-profit-mode', String(body.protect_profit_mode ?? 'none'),
    '--lock-profit-reaches', String(body.lock_profit_reaches ?? 0),
    '--lock-profit-min',     String(body.lock_profit_min     ?? 0),
