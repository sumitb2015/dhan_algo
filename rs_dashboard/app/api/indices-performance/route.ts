...
const INDEX_LIST: IndexMeta[] = [
  ...
  { symbol: 'NIFTYMEDIA',    label: 'Nifty Media',                    category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_MEDIA.csv') },
  { symbol: 'NIFTYHEALTHCARE', label: 'Nifty Healthcare',             category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_HEALTHCARE.csv') },
  { symbol: 'NIFTYCDURBL',   label: 'Nifty Consumer Durables',        category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_CONSR_DURBL.csv') },
  { symbol: 'NIFTYFINSRV2550', label: 'Nifty Fin Services 25/50',     category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_FINSRV25_50.csv') },
  { symbol: 'NIFTYOILGAS',   label: 'Nifty Oil and Gas',              category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_OIL_GAS.csv') },
  { symbol: 'NIFTYMSMHLTH',  label: 'Nifty MidSmall Healthcare',      category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_MIDSML_HLTH.csv') },
  { symbol: 'NIFTYFINEXBNK', label: 'Nifty Fin Services Ex-Bank',     category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_FINSEREXBNK.csv') },
  { symbol: 'NIFTYMSFIN',    label: 'Nifty MidSmall Fin Services',    category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_MS_FIN.csv') },
  { symbol: 'NIFTYMSITTELCM', label: 'Nifty MidSmall IT & Telecom',   category: 'Sectoral', csvPath: path.join(INDICES_DIR, 'NIFTY_MS_IT_TELCM.csv') },
  // ── Volatility ────────────────────────────────────────────────────────────
