...
export const TERMINAL_PILLARS: TerminalPillarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Market Regime & Distribution Days',
        href: '/market-regime',
        badge: 'REGIME',
        desc: "CANSLIM Institutional Distribution Days (Nifty 50 & 500) & Follow-Through Day bottom detection",
        hot: true,
      },
      {
        name: 'Minervini Stage 2 & VCP Screener',
        href: '/stage-screener',
        badge: 'STAGE 2',
        desc: 'Mark Minervini 8-point trend template & Stan Weinstein Stage 2 breakout screener with VCP detection',
        hot: true,
      },
      {
        name: '52-Week High/Low & Base Proximity',
        href: '/highs-lows',
        badge: 'HIGHS/LOWS',
        desc: 'Categorize Nifty 500 stocks by proximity to 52-week highs, base consolidation, and Net New Highs expansion',
        hot: true,
      },
      {
        name: 'Sector Depth & Breadth Heatmap',
        href: '/sector-breadth',
        badge: 'SECTORS',
        desc: 'Track % of stocks above 20, 50, and 200 DMA across all 27 sectors with internal thrust detection',
        hot: true,
      },
      {
        name: 'Multi-Timeframe Trend Confluence',
        href: '/trend-confluence',
        badge: 'CONFLUENCE',
        desc: 'Multi-timeframe Weekly 10/40 & Daily 50/200 EMA alignment, 20 EMA momentum & ADX trend filter',
        hot: true,
      },
      {
        name: 'Statistical Distribution Histogram',
        href: '/distribution',
        desc: 'Historical daily return distributions, skewness, and kurtosis analysis',
      },
      {
