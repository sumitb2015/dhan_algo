...
export default function TopMetricBar({
  ...
  return (
    <header className="sticky top-0 z-30 w-full border-b border-zinc-800 bg-zinc-950/95 backdrop-blur px-3 md:px-4 py-2 flex flex-wrap items-center justify-between gap-2.5 text-xs font-mono select-none shadow-lg">
