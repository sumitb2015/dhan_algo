...
export default function PositionsStrategyMonitor({
  ...
  return (
    <div className="flex flex-col gap-4 font-mono select-none">
      ...
      {(() => {
        const payoffPanel = (
          <div className={isPayoffFullscreen ? 'fixed inset-0 z-50 overflow-y-auto bg-zinc-950 p-4 md:p-6 flex flex-col' : 'w-full'}>
            <TerminalPanel
  ...
  if (isPayoffFullscreen && typeof document !== 'undefined') {
    return createPortal(payoffPanel, document.body);
  }
  return payoffPanel;
})()}
    </div>
