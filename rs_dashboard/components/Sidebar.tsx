...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/backtest-vectorbt', label: 'VectorBT Backtester', desc: 'Vectorized EMA/RSI/Donchian/Supertrend/MACD backtests on Dhan data with Indian cost models & OpenStatz tearsheet' },
