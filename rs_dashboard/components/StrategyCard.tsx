  ...
  const configPanel = (
    <div className="flex flex-col gap-2.5 border border-zinc-800/60 px-3 py-2.5 rounded-lg bg-zinc-950/30">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 text-xs">
        ...
        {meta.key !== 'nifty_spread_trend' && meta.key !== 'crudeoilm_supertrend' && meta.key !== 'crudeoilm_renko_sar' && meta.key !== 'crudeoilm_vwap_supertrend' && meta.key !== 'crudeoilm_ema_supertrend' && meta.key !== 'crudeoilm_orb' && meta.key !== 'nifty_st_oi_bearcall' && meta.key !== 'nifty500_momentum' && meta.key !== 'nifty_delta_strangle' && meta.key !== 'nifty_flyagonal' && meta.key !== 'nifty_volcano_calendar' && (
          <div className={fieldCls}>
