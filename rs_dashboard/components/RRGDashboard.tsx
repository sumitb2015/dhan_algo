  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 flex flex-col">
      ...
      <header className="bg-zinc-900 border-b border-zinc-800 px-4 py-3 flex items-center gap-4 sticky top-0 z-30 flex-wrap">
        <div>
          <div className="text-sm font-bold text-zinc-100 tracking-wide uppercase">Relative Rotation Graph</div>
          <div className="text-xs text-zinc-500 tracking-widest">Sector Rotation · Nifty Universe</div>
        </div>
        <NavBar />
        <div className="flex items-center gap-3 ml-2">
          <label className="flex items-center gap-1.5 cursor-pointer text-xs font-bold text-zinc-300">
            <input
              ...
              className="h-3.5 w-3.5 text-blue-400 border-zinc-600 focus:ring-blue-500 cursor-pointer"
            />
            <span>RRG</span>
          </label>
          <label className="flex items-center gap-1.5 cursor-pointer text-xs font-semibold text-zinc-500">
            <input
              type="radio"
              name="rrgMode"
